...
<div class="content" style="padding-top: 0px;padding-bottom: 0px;margin-top: 40px;">
    <div class="container-fluid" style="padding-top: 0px;padding-bottom: 0px;">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" action="<?php echo base_url(); ?>Master/Postres/editarPostre" class="form-horizontal" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group label-floating">
                                            ...
                                            <input type="hidden" name="id_postre" value="<?php echo $alimento['id_postre']; ?>">
