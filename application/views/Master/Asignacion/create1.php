...
<div class="content" style="padding-top: 0px;padding-bottom: 0px;margin-top: 40px;">
    <div class="container-fluid" style="padding-top: 0px;padding-bottom: 0px;">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <form method="POST" action="<?php echo base_url(); ?>Master/Asignacion/nuevaAsignacion_Caja" class="form-horizontal" enctype="multipart/form-data">
                        ...
                        <div class="card-content">                       
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-sm-6">
                                        <select class="form-group selectpicker" data-style="btn btn-info btn-round" title="Selecciona Sucursal" data-size="7" required="true" name="id_sucursal">
                                            <?php if (count($sucursal1)) {
                                                foreach ($sucursal1 as $list) {
                                ...
                                <div class="col-md-6">
                                    <label class="col-sm-3 label-on-left"><b>Caja:</b></label>
                                    <div class="col-sm-6">
                                        <select class="form-group selectpicker" data-style="btn btn-info btn-round" title="Selecciona caja" data-size="7" required="true" name="id_caja">
                                            <?php if (count($caja)) {
                                                foreach ($caja as $list) {
                                                    echo "<option value='". $list['id_caja'] . "'>" . ucwords($list['nombre']) . "</option>";
                                                }
                                            }
                                            ?>
                                        </select>
