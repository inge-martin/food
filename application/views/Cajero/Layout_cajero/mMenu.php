...
<div class="sidebar" data-active-color="rose" data-background-color="black" data-image="<?php echo base_url(); ?>assets/img/sidebar.jpg"><!-- data-color="purple | blue | green | orange | red -->
  ...
  <div class="logo">
    <a href="<?php echo base_url(); ?>Cajero/Inicio" class="simple-text">
      Food and Drink's
    </a>
  </div><!-- Logo -->
  ...
  <div class="sidebar-wrapper">
    ...
    <div class="user">
      <div class="photo">
        <img src="<?php echo base_url(); ?>assets/fotos/cajero/<?php echo $this->session->userdata('s_fotografia'); ?>">
      </div>
      <div class="info">
        ...
        <div class="collapse" id="collapseExample">
          <ul class="nav">
            <li>
              <a href="<?php echo base_url(); ?>Cajero/Perfil">
