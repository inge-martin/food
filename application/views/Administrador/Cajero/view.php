			...
			<div class="col-md-6">
				<div class="card card-profile">
					<div class="card-avatar">
						<img class="img" src="<?php echo base_url('assets/fotos/cajero/') . $admin['fotografia']; ?>" />
					</div>
					<div class="content">
						<h3 class="category text-success">
							<?php echo ucwords($admin['nombre']. " " .$admin['paterno'] . " " . $admin['materno'] ); ?><br>
							<small>"Cajero de sucursal"</small>
						</h3>
					...
					<a class="btn btn-info btn-round" href="<?php echo base_url('Administrador/Cajero'); ?>">Regresar</a>
				</div>
			</div>          
		</div>
	</div>
