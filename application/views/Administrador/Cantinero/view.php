			...
			<div class="col-md-6">
				<div class="card card-profile">
					<div class="card-avatar">
						<img class="img" src="<?php echo base_url('assets/fotos/cantinero/') . $admin['fotografia']; ?>" />
					</div>
					<div class="content">
					...
					<a class="btn btn-info btn-round" href="<?php echo base_url('Administrador/Cantinero'); ?>">Regresar</a>
				</div>
			</div>          
		</div>
	</div>
